  ...
  public void squish() {
    // Fill in your solution here.  (Ours is eleven lines long.)
	  if(head != null && head.next != null){
		  SListNode cur_node = head;
		  SListNode nex_node = cur_node.next;
		  do{
			  Object cur_ite = cur_node.item;
			  Object nex_ite = nex_node.item;
			  if(cur_ite.equals(nex_ite)){
  ...
  public void twin() {
    // Fill in your solution here.  (Ours is seven lines long.)
	  if(size != 0){
		  SListNode cur_node = head;
		  do{
			  SListNode copy = new SListNode(cur_node.item);
