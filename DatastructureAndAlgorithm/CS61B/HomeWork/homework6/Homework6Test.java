...
//    }
    ...
    // from here.
    int actCollisions, expCollisions;
    actCollisions = table.computeCollisions();
    expCollisions = table.expectedCollisions(numBoards);
    System.out.println("========== Entrys: " + numBoards + " ==========");
    table.distribution();
    System.out.println();
    System.out.println("The load factor: " + table.getLoadFactor());
    System.out.println("The expected number of collisions: " + expCollisions);
    System.out.println("The actual number of collisions: " + actCollisions);
